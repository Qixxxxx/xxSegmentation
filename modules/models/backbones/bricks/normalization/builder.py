...
from modules.models.backbones.bricks.normalization.grn import GRN
from modules.models.backbones.bricks.normalization.layernorm2d import LayerNorm2d
from utils import BaseModuleBuilder


class NormalizationBuilder(BaseModuleBuilder):
    REGISTERED_MODULES = {
        'LayerNorm': nn.LayerNorm, 'LayerNorm2d': LayerNorm2d, 'GroupNorm': nn.GroupNorm,
